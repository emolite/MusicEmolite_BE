...
namespace MS_Application.External
{
    ...
    {
        private readonly Cloudinary _audioCloudinary;
        private readonly Cloudinary _imageCloudinary;

        public CloudinaryService(Cloudinary audioCloudinary, CloudinaryImageService imageService) 
        { 
            _audioCloudinary = audioCloudinary; 
            _imageCloudinary = imageService.Cloudinary; 
        }

        public string BuildAudioUrl(string publicId)
        {
            return _audioCloudinary.Api.UrlVideoUp
        ...
        public async Task<BaseResponse<string>> UploadVideoAsync(IFormFile file)
        {
            ...
            var result = await _audioCloudinary.UploadAsync(uploadParams);
